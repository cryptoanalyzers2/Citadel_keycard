...
public class KeycardApplet extends Applet {
  ...
  static final byte SIGN_P1_DERIVE_AND_MAKE_CURRENT_ED = 0x12;
  static final byte SIGN_P1_PINLESS_ED = 0x13;
...
else
{
    ...
    if(test_ed25519 == true)
    {
		 ...
		 apduBuffer[(short)(SecureChannel.SC_OUT_OFFSET + 4)] = Crypto.KEY_PUB_SIZE_ED;
	     short outLen = Crypto.KEY_PUB_SIZE_ED;
